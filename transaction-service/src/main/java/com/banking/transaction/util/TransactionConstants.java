...
public class TransactionConstants {
    ...
    public static final String NO_TRANSACTIONS_FOUND = "No transactions found for the account";
    ...
    public static final String ACCOUNT_NOT_FOUND = "One or both accounts not found";
    public static final String BALANCE_UPDATE_FAILED = "Failed to update account balances";
